  ...
  \section{Work Experience}
    ...
    \workexp{Founder}
      ...
      {Spain}
      {
        ...
        \item Discovered several ways to not parse unstructured product titles (Vector Search, Keyword Discovery, Entity Recognition, etc) and ended interpreting them -and user queries- against a Bayesian Network developed using a locally-run LLM.
