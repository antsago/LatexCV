...
\begin{document}
  ...
  \section{Personal profile}
    {
      I am software developer with a broad knowledge in AI that takes pride in writing testable and readable code.
      I am passionate about entrepreneurship and how economic, social and technological trends shape our world and 
      thirst for learning and meeting new cultures and ways of thinking. 
    }
  ...
  \section{Work Experience}
    ...
    \workexp{NextGame Sport CoFounder}
      ...
      {U.K.}
      {
        \item CoFounder of NextGame Sport: an sports predictions startup accepted into the
          Entreprenurial Spark accelerator that seeked to better connect fans and brands together.
