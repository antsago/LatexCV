...
\begin{document}
  ...
  \section{Work Experience}
    ...
    \workexp{Senior Javascript Developer}
      {Apr 2021-Now}
      {Cyferd}
      {Remote}
      {Spain}
      {
        \item Started in the React.js frontend where I added -among others- interactivity to our dynamic views
        \item Transitioned to the backend where I led a 5-person team from PoC to a production platform
        \item Work with technologies like Node.js, Websockets, Kafka, Mongo, Redis, etc.
      }
